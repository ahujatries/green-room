// AUTO-GENERATED from the Bee Movie (2007) spoken-dialogue corpus (the
// complete "entire bee movie script" line dump — spoken lines only, no scene
// headings or attributions). This is the full "page" the sample cast is
// grounded in. Do not edit by hand.

export const BEE_MOVIE_TEXT = `
