...
export const CHARACTERS: Character[] = [
  {
    ...
    blurb: "Closing the Mirador alone. Sharp, guarded, answers questions with questions.",
    voiceNote:
...
- He slides a sealed, worn envelope halfway across the counter. She looks at it. She does NOT touch it. Her only reply is "Drink your coffee."`,
  ...
  },
  {
    ...
    blurb: "Nurses a coffee he won't drink. Knows more than he'll say. Carries a sealed envelope.",
    voiceNote:
